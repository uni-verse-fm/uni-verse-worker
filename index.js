...
const processHeavyTask = msg => bb.resolve(console.log('MESSAGE RECEIVED')).then(
    setTimeout((() => console.log(msg.content.toString())), genRandomTime())
)
...
const assertAndConsumeQueue = async (channel) => {
    ...
    const ackMsg = (msg) => bb.resolve(msg)
